...
/*BOOST_AUTO_TEST_SUITE(url_parser)
	BOOST_AUTO_TEST_SUITE(url_string_representation)
		...
		BOOST_AUTO_TEST_CASE(no_throw_empty_port)
		{
			BOOST_REQUIRE_NO_THROW(CHttpUrl url("http://localhost:/index.php"));
		}
		BOOST_AUTO_TEST_CASE(no_throw_ping_port)
		{
			BOOST_REQUIRE_NO_THROW(CHttpUrl url("http://localhost/index.php"));
		}
